...
const mockBudgets = [
    { id: 1, category: { name: "Oziq-ovqat", icon: "🍔", color: "#2d7a55" }, amount: 500, spent: 420 },
    { id: 2, category: { name: "Transport", icon: "🚗", color: "#a06040" }, amount: 200, spent: 215 },
    { id: 3, category: { name: "Ko'ngil ochar", icon: "🎮", color: "#1a4d3a" }, amount: 150, spent: 85 },
];
